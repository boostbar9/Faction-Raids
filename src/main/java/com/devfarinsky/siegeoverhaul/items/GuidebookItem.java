 ...
 * need to type {@code /siegeoverhaul menu} to reach it.
 *
...
public class GuidebookItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.siegeoverhaul.guidebook.tooltip.line1"));
        tooltip.add(Component.translatable("item.siegeoverhaul.guidebook.tooltip.line2"));
    }
}
