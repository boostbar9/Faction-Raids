...
public enum CommandIcon {
    ...
    /** Field Supplies crate: roped canvas over a plain timber box. */
    SUPPLY_CRATE(0xffb9894f,
            "                ",
            "                ",
            "   .........    ",
            "  .=========.   ",
    ...
    /** Veteran Armory chest: iron bands and a heavy lock plate. */
    ARMORY_CRATE(0xffb8c4d4,
            "                ",
            "    .=.....=.   ",
            "   .=#=###=#=.  ",
            "  .==#=###=#==. ",
    ...
    /** Royal Treasury reliquary: crowned gold casket on clawed feet. */
    ROYAL_CRATE(0xffe8c968,
            "                ",
            "   =  ===  =    ",
            "   ==.===.==    ",
            "   .=======.    ",
