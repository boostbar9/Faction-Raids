...
public final class DefensePlaybook {
    ...
    public static final List<Tip> TIPS = List.of(
            new Tip("Stronghold",
                    ...
                    "Any bed or respawn anchor you sleep at becomes your stronghold. If you move your bed mid-raid the objective does not follow \u2014 finish the current siege first, then relocate. Use /siegeoverhaul home refresh after sleeping to update it explicitly."),
            new Tip("Walls",
            ...
            new Tip("Rewards",
                    ...
                    "The Overview tab's DEFENSE FORECAST card (shown when no siege is active) lists 'Reward eligible: yes/no'. During the live siege that indicator is not visible \u2014 by then it's locked in. Check the forecast before triggering /siegeoverhaul start."),
            new Tip("Emergency",
                    "/siegeoverhaul stop is for admins only",
